...
```{r}
#add a variable which can let users select ways of calculate the target.
game_sign=function(A,b=24,Sign=c("+","-","*","/")){
  a<-sign(Sign)
  len=length(A)
  B=permn(A)
  stopifnot(len==4)
